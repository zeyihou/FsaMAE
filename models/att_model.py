...
class AttModel(CaptionModel):
    def __init__(self, tokenizer, max_caption_length):
        super(AttModel, self).__init__()
        self.tokenizer = tokenizer
        self.vocab_size = tokenizer.vocab_size - 1   # 词汇表大小为50257,这里减1， 未包含特殊字符 50256
        self.input_encoding_size = 512
        self.rnn_size = 512
        self.num_layers = 3
        self.drop_prob_lm = 0.5
        self.max_seq_length = max_caption_length
        self.att_feat_size = 768    #  d_vf:768  为了 VIT 的维度 768
